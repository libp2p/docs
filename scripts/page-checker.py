...
htmlToTest = markdownToTest.replace("content/","public/").replace("_index.md","index.html").replace("index.md","index.html").replace(".md","/index.html")
...
for codeBlock in soup.find_all("pre"):
    codeBlock.decompose()
foundDiv = soup.find_all('div', attrs={'id': 'body-inner'}, limit=1)
print('found div', foundDiv)
...
for link in links:
    ...
    "docs.libp2p.io" not in linkUrl and
    "https://github.com/libp2p/docs" not in linkUrl and
