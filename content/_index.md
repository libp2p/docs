...
Get in touch with other members of the libp2p community who are building tools and applications with libp2p! You can ask questions, discuss new ideas, or get support for problems at [IPFS discussion forums](https://discuss.ipfs.io), but you can also [hop on IRC](irc://irc.freenode.org/%23libp2p) for a quick chat.
