...
- [NAT traversal]({{< ref "/concepts/nat/overview.md" >}}): WebRTC includes mechanisms (like
...
[Noise handshake]({{< ref "/concepts/secure-comm/noise.md" >}}) following the DTLS handshake.
