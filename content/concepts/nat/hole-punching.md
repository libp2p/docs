...
1. [AutoNAT]({{< ref "/concepts/nat/autonat.md" >}}): Determine whether a node is dialable,
...
2. [Circuit Relay]({{< ref "/concepts/nat/circuit-relay.md" >}}): Connect to and request
...
1. [Circuit Relay]({{< ref "/concepts/nat/circuit-relay.md" >}}): Establish a secure relay connection
